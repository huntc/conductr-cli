...
from conductr_cli.conduct import build_parser, get_cli_parameters, host
...
class TestConduct(TestCase):
    ...
    def test_get_cli_parameters(self):
        ...
        self.assertEqual(get_cli_parameters(args), ' --ip 127.0.0.1 --port 9006')

        args = Namespace(ip=None, port=9005, api_version='1.1')
        self.assertEqual(get_cli_parameters(args), ' --ip 127.0.0.1 --api-version 1.1')

        args = Namespace(ip=None, port=9006, api_version='1.1')
        self.assertEqual(get_cli_parameters(args), ' --ip 127.0.0.1 --port 9006 --api-version 1.1')
